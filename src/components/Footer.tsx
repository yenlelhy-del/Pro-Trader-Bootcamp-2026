...
export default function Footer() {
  return (
    <footer className="bg-[#080706] border-t border-brand-surface-bright/50 py-12 mt-12 text-brand-gray">
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-[11px] space-y-4 md:space-y-0">
          <p>© 2026 PRO TRADER BOOTCAMP. All rights reserved. Built for institutional trading discipline.</p>
